...
- **Supabase Auth**: login con usuario + contraseña (mínimo 6 caracteres,
  con al menos una mayúscula y un número). Por dentro se genera un email
  interno a partir del usuario; nadie lo ve ni lo escribe.
...
el código de invitación ya puesto — solo eligen su usuario y una contraseña
(mín. 6 caracteres, con mayúscula y número). Nadie edita archivos ni toca
